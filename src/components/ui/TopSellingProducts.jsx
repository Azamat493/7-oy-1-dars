...
export default function TopSellingProducts() {
  ...
  return (
    <div className="bg-white rounded-xl p-4 border border-gray-100 overflow-x-auto scrollbar-custom">
      ...
      <div className="flex justify-between items-center font-medium text-xs leading-[150%] text-[color:var(--light-text-text-primary)] font-family mb-2 px-2 min-w-max">
        <div className="w-[200px]">PRODUCTS</div>
        <div className="w-[80px] ">SELLS</div>
        <div className="w-[100px] ">CATEGORY</div>
        <div className="w-[80px] ">PRICE</div>
        <div className="w-[120px] ">TOTAL REVENUE</div>
      </div>
      ...
      <div className="space-y-3 min-w-max">
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="font-normal text-sm leading-[157%] text-[color:var(--light-text-text-primary)] font-family w-[80px]">
              {product.sales}
            </div>

            <div className="font-normal text-sm leading-[157%] text-[color:var(--light-text-text-primary)] font-family w-[100px]">
              {product.category}
            </div>
            ...
            <div className="font-normal text-sm leading-[157%] text-[color:var(--light-text-text-primary)] font-family w-[120px]">
              {product.revenue}
            </div>
          </div>
        ))}
